...
type
  //ShortStringBase for Delphi < 2009 compatibility
  ShortStringBase = ShortString;
              ...
              case TypeTypeInfo.Kind of
                ...
                tkEnumeration:
                  begin
                    ...
                    // TODO: replace by function call as EnumUnitName is not available as field any more:
